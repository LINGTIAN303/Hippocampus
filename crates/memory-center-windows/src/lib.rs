...
//!
//! - Independent：Agent 工具独立管理上下文，MemoryCenter 被动接收归档
//! - Cooperative（v2）：协同管理，MemoryCenter 可建议保留记忆
//!
//! ## 架构定位
//!
//! 本 crate 是 5 个特配 crate 之一，与 MemoryCenter-models/scenarios/agents/skills 平行，
//! 不依赖其他特配 crate，联动由 MemoryCenter-presets 组合层处理。
