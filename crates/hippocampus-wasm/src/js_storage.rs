...
use hippocampus_core_logic::model::{ArchivePeriod, IndexDocument, IndexHook, MemoryFile};
use hippocampus_core_logic::storage::{SessionMeta, Storage};
use hippocampus_core_logic::{Error, Result as CoreResult};
use js_sys::Function;
...
// JsStorage 在 WASM 下用 ?Send（JsFuture 不 Send）
